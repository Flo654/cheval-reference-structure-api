 ...
 */
final class Version20220223100425 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE staff (id INT AUTO_INCREMENT NOT NULL, structure_id INT DEFAULT NULL, identity VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, job VARCHAR(255) DEFAULT NULL, text LONGTEXT DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, internal TINYINT(1) NOT NULL, activated TINYINT(1) NOT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_426EF3922534008B (structure_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE staff ADD CONSTRAINT FK_426EF3922534008B FOREIGN KEY (structure_id) REFERENCES structures (id)');
    }
