 ...
 */
final class Version20220223110416 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE installations (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, icon VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE installations_structures (installations_id INT NOT NULL, structures_id INT NOT NULL, INDEX IDX_F56360072B6BB138 (installations_id), INDEX IDX_F56360079D3ED38D (structures_id), PRIMARY KEY(installations_id, structures_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE installations_structures ADD CONSTRAINT FK_F56360072B6BB138 FOREIGN KEY (installations_id) REFERENCES installations (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE installations_structures ADD CONSTRAINT FK_F56360079D3ED38D FOREIGN KEY (structures_id) REFERENCES structures (id) ON DELETE CASCADE');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE installations_structures DROP FOREIGN KEY FK_F56360072B6BB138');
        $this->addSql('DROP TABLE installations');
        $this->addSql('DROP TABLE installations_structures');
